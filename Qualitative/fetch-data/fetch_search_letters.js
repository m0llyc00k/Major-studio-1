...
const search =  `object_type: letters (correspondence) AND online_media_type:"Images"`;
...
function addObject(objectData) {  
  ...
  if(objectData.content.freetext.physicalDescription) {
    currentMedium = objectData.content.freetext.physicalDescription[0].content;}
    
  let currentDepict = "";
  if(objectData.content.freetext.name) {
    currentDepict = objectData.content.freetext.name;}
...
// <freetext category=”name” label=“depicts”>